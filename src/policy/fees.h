...
static constexpr CAmount MIN_FEERATE(10);
static const CAmount MAX_FEERATE(int64_t(1e7));
static const CAmount INF_FEERATE(MAX_MONEY);
static const CAmount INF_PRIORITY(int64_t(1e9) * MAX_MONEY);
