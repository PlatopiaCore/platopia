...
static const uint64_t DEFAULT_MAX_GENERATED_BLOCK_SIZE = 1750000;
...
static const CAmount DEFAULT_BLOCK_MIN_TX_FEE(1000);
 ...
 */
static const CAmount DUST_RELAY_TX_FEE(1000);
