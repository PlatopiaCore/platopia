...
static const CRPCConvertParam vRPCConvertParams[] = {
    ...
    {"eth_submitHashrate", 0, "hashrate"},
    {"eth_submitWork", 0, "hexnonce"},
    {"eth_submitWork", 1, "blockheaderHash"},
    {"eth_submitWork", 2, "hexhashmix"},
    ...
    {"deposittoaddress", 0, "lockdays"},
    {"deposittoaddress", 1, "principal"},
    ...
    {"getlockinterest", 0, "lockdays"},
    {"getlockinterest", 1, "principal"},
