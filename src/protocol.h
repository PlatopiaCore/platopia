...
enum ServiceFlags : uint64_t {
    ...
    // It is currently set by all Platopia Core nodes, and is unset by SPV clients
    ...
    // protocol request. Platopia Core does not support this but a patch set
    ...
    // connections. Platopia Core nodes used to support this by default, without
