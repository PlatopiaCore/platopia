...
static void MempoolEviction(benchmark::State &state) {
    ...
    while (state.KeepRunning()) {
        AddTx(tx1, CAmount(10000LL), pool);
        AddTx(tx2, CAmount(5000LL), pool);
        AddTx(tx3, CAmount(20000LL), pool);
        AddTx(tx4, CAmount(7000LL), pool);
        AddTx(tx5, CAmount(1000LL), pool);
        AddTx(tx6, CAmount(1100LL), pool);
        AddTx(tx7, CAmount(9000LL), pool);
