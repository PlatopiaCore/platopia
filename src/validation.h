...
static const CAmount DEFAULT_MIN_RELAY_TX_FEE(1000 * 100); // Update from 1000 PerKB to 100 SatoshiPerB
//! -maxtxfee default
...
bool AcceptToMemoryPool(const Config &config, CTxMemPool &pool,
                        ...
                        const CAmount nAbsurdFee = CAmount(0));
