...
- [Building Platopia Core](#building-platopia)
...
To build Platopia Core (for Linux, OS X and Windows) run the following commands:

```bash
URL=https://github.com/platopia/platopia.git
