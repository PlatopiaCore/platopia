...
8. Upload gitian build to [platopia.org](https://download.platopia.org/)

9. Re-verify the uploads (make sure that downloading them, their checksums are ok)

10. Create a [GitHub release](https://github.com/Platopia-Core/platopia/releases) 


## After Release

11. Update version number on www.platopia.org
...
13. Announce Release:
    ...
    - Twitter @Bitcoin_ABC
    - Public slack channels friendly to Platopia Core announcements 
