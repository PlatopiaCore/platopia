UNIX BUILD NOTES
====================
Some notes on how to build Platopia Core in Unix.
...
memory available when compiling Platopia Core. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Platopia Core without wallet.
...
# Configure Platopia Core to use our own-built instance of BDB
cd $BITCOIN_ROOT
./autogen.sh
...
This example lists the steps necessary to setup and build a command line only, non-wallet distribution of the latest changes on Arch Linux:
    ...
    git clone https://github.com/Platopia-Core/platopia
    cd platopia/
    ./autogen.sh
